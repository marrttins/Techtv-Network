...
<div class="admin-form-container" style="max-width: 750px;">
    ...
    <form action="{{ url('/admin/videos') }}" method="POST" enctype="multipart/form-data" style="display: flex; flex-direction: column; gap: 1.25rem;">
        @csrf
        ...
        <div id="yt-preview-box" style="display: none; background: #f8fafc; border: 1px solid var(--admin-border); border-radius: 8px; padding: 1rem; align-items: center; flex-wrap: wrap; gap: 1rem;">
