...
<div class="post-editor" style="max-width: 600px;">
    <form action="{{ url('admin/users') }}" method="POST">
        ...
        <div class="form-group" id="permissions-group">
            ...
            <p style="font-size: 0.85rem; color: var(--text-muted); margin-top: 0.5rem;">Note: Super-Admins automatically have all permissions.</p>
        </div>

        <div style="margin-top: 2rem;">
            <button type="submit" class="btn-primary" style="padding: 0.75rem 1.5rem; border-radius: 6px; width: 100%; border: none; cursor: pointer; font-size: 1rem;">Create User</button>
        </div>
    </form>
</div>
